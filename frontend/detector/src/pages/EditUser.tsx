            ...
            <form onSubmit={(e) => { handleUpdate(e) }}>
              ...
              <div className="py-6 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                ...
                <div className="mt-2 space-y-3">
                  ...
                  <div className="mt-2 space-y-3"></div>
                  <input required placeholder="Rename your device" value={deviceStatus} onChange={(e) => { setDeviceStatus(e.target.value) }} className="py-2 px-3 pe-9 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" />
